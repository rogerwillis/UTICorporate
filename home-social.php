...
<html lang="en">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab" class="bg-blue white"><i class="icon-s-facebook"></i></a></li>
    <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab" class=""><i class="icon-s-youtube"></i></a></li>
    <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><i class="icon-s-twitter"></i></a></li>
    <li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab"><i class="icon-s-instagram"></i></a></li>
  </ul>
  ...
  <div class="tab-content">
    ...
    <div class="fb-page" data-href="https://www.facebook.com/uti" data-width="500" data-height="600" data-hide-cover="false" data-show-facepile="true" data-show-posts="true">
        <div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/uti">
            <a href="https://www.facebook.com/uti">Universal Technical Institute</a></blockquote></div></div>
    
    </div>
    <div role="tabpanel" class="tab-pane" id="profile">YOUTUBE</div>
    <div role="tabpanel" class="tab-pane" id="messages">TWITTER</div>
    <div role="tabpanel" class="tab-pane" id="settings">INSTAGRAM</div>
  </div>
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.3&appId=172173329521024";
