...
(function ($) {
    ...
    function megaMenuDropDownPosition() {
        ...
        if (($(window).width() < 750) && (settings.menu_responsive === 1)) {
          $('.dropdown_container, .dropdown_fullwidth').css({'top':'auto'}).hide();
         /*   $('.dropdown_first').css({'left':'0'}).hide();*/
            ...
            $('.dropdown_container').css({'top':'auto'}).hide();
            $('.dropdown_fullwidth').css({'top':'auto'}).hide();
